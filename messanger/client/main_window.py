...
sys.path.append('../')
from messager.client.main_window_conv import Ui_MainClientWindow
from messager.client.add_contact import AddContactDialog
from messager.client.del_contact import DelContactDialog
from messager.client.client_database import ClientDatabase
from messager.client.transport import ClientTransport
from messager.client.start_dialog import UserNameDialog
from messager.data.errors_user import ServerError
