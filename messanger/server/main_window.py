...
from messanger.server.stat_window import StatWindow
from messanger.server.config_window import ConfigWindow
from messanger.server.add_user import RegisterUser
from messanger.server.remove_user import DelUserDialog
